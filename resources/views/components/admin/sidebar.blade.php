        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex items-center justify-between px-4 py-3">
                <a href="/" class="flex items-center shrink-0">
                    <span
                        class="text-2xl mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">DASHBOARD</span>
                </a>
            </div>
            <ul class="flex flex-col font-semibold gap-2">
                <h2
                    class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] mb-1">
                    ...
                    <ul>
                        <li class="nav-item">
                            <a href="{{ route('dashboard') }}"
                                class="group {{ Route::is('dashboard') ? 'active' : '' }}">
                                <div class="flex items-center">
                                    <svg class="shrink-0" width="20" height="20" viewBox="0 0 24 24"
                    ...
                    <ul>
                        <li class="nav-item">
                            <a href="{{ route('dashboard.product.index') }}"
                                class="group {{ Route::is('dashboard.product.*') ? 'active' : '' }}">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Product</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li class="nav-item">
                            <a href="{{ route('dashboard.kategori.index') }}"
                                class="group {{ Route::is('dashboard.kategori.*') ? 'active' : '' }}">
                                <div class="flex items-center">
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Kategori</span>
                                </div>
                            </a>
                        </li>
                    </ul>
